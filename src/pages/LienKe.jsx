    ...
    <div id="article" className="">
      <div className="container">
        <div className="col-md-10 col-md-offset-1">
          ...
          <p>
            Biệt thự liền kề Vinhomes trong những năm gần đây được đánh giá là sản phẩm nhà ở rất được khách hàng ưa chuộng bởi diện tích phù hợp, giá cả phải chăng. Để tiếp nối thành công đó Chủ đầu tư đang chuẩn bị cho ra mặt dòng sản phẩm biệt thự liền kề Vinhomes Wonder City, hứa hẹn sẽ là cơn sốt trên thị trường BĐS thời gian tới.
          </p>
          <p>
          ...
          <div className="divide"></div>
          <p>
            Biệt thự liền kề tại các dự án của chủ đầu tư Vingroup luôn là dòng sản phẩm được săn đón hàng đầu và bán chạy nhất, giới đầu tư gọi đây là món mồi ngon để đầu tư lướt sóng và cả dài hạn. Lý do vì sao lại như vậy? Bởi khả năng tăng giá cao, tính thanh khoản nhanh, diện tích các biệt thự vừa phải, giá mềm, dễ đầu tư, thu hồi vốn nhanh và hơn hết là tính năng sử dụng tối ưu vừa để kinh doanh, vừa để ở đều được.
          </p>
          <p>
            Nếu bạn là nhà đầu tư lướt sóng thì khả năng sinh lời lên đến 60% – 80% trong vòng vài tháng là điểu hiển nhiên. Hay là đầu tư dài hạn cho thuê thì Vinhomes Wonder City Đan Phượng hứa hẹn sẽ mang lại lợi nhuận khủng cho nhà đầu tư, trung bình giá cho thuê sẽ giao động từ 30 -40 triệu/ tháng.
          </p>
