      ...
      <div className="container">
        <div className="section-title">
          ...
          <p className="text-content">
            Dự án Vinhomes Wonder Park cũng giống như những dự án cao cấp khác của tập đoàn Vingroup, đều được thiết kế với quy mô hoành tráng, hiện đại, thượng lưu cũng như độc đáo nhất trên thị trường hiện nay.
          </p>
